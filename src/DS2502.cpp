...
{
    static_assert(OW_MEM_SIZE < 256, "Implementation does not cover the whole address-space");
...
void DS2502::clearMemory(void) { memset(memory, static_cast<uint8_t>(0xFF), OW_MEM_SIZE); }
